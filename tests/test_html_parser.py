...
class TestProjectPageParserMethods(unittest.TestCase):
    ...
    def test_parse(self):
        self.assertEqual(ProjectPageParser(self.test_html).parse(), AttrDict(pps.project_summary_dict["project"]))
...
class TestProjectCommentsPageParserMethods(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(ProjectCommentsPageParser(test_html).parse(), AttrDict(pps.backers))
